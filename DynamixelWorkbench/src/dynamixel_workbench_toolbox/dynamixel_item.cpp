...
static const ModelInfo info_AR = {0.229,
                                  0,
                                  8192,
                                  16384,
                                  -3.14159265, 
...
const ControlItem *DynamixelItem::getControlTable(uint16_t model_number)
{
  ...
  else if (num == XL430_W250 || num == XL430_W250_2 || num == XC430_W150 || num == XC430_W240 || num == XC430_W250_2 || num == AR430_W250)
  {
